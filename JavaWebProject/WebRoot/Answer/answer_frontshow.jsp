...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>Answer/frontlist">答卷信息信息</a></li>
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">选项信息:</div>
		<div class="col-md-10 col-xs-6"><%=answer.getSelectOptionObj().getOptionContent() %></div>
	</div>
	<div class="row bottom15"> 
