...
<jsp:include page="../header.jsp"></jsp:include>
				    				...
				    				<table class="table table-condensed table-hover">
				    					...
				    					<% 
 										...
 										<tr>
 											...
 											<td><%=guestBook.getUserObj().getName() %></td>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="guestBookQueryForm" id="guestBookQueryForm" action="<%=basePath %>GuestBook/frontlist" class="mar_t15" method="post">
            ...
            <div class="form-group">
            	<label for="userObj_userInfoname">留言人：</label>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="guestBook_userObj_userInfoname_edit" class="col-md-3 text-right">留言人:</label>
		  	 <div class="col-md-9">
			    <select id="guestBook_userObj_userInfoname_edit" name="guestBook.userObj.userInfoname" class="form-control">
			    </select>
		  	 </div>
		  </div>
		  <div class="form-group">
			...
			if (guestBook) {
				...
				$.ajax({
					...
					success: function(userInfos,response,status) { 
						$("#guestBook_userObj_userInfoname_edit").empty();
						var html="";
		        		$(userInfos).each(function(i,userInfo){
		        			html += "<option value='" + userInfo.userInfoname + "'>" + userInfo.name + "</option>";
		        		});
		        		$("#guestBook_userObj_userInfoname_edit").html(html);
		        		$("#guestBook_userObj_userInfoname_edit").val(guestBook.userObjPri);
					}
				});
