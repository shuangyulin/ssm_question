...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>GuestBook/frontlist">留言信息信息</a></li>
  		<li class="active">详情查看</li>
	</ul>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">记录编号:</div>
		<div class="col-md-10 col-xs-6"><%=guestBook.getGuestBookId()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">留言标题:</div>
		<div class="col-md-10 col-xs-6"><%=guestBook.getTitle()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">留言内容:</div>
		<div class="col-md-10 col-xs-6"><%=guestBook.getContent()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">留言人:</div>
		<div class="col-md-10 col-xs-6"><%=guestBook.getUserObj().getName() %></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">留言时间:</div>
		<div class="col-md-10 col-xs-6"><%=guestBook.getAddTime()%></div>
	</div>
	<div class="row bottom15">
