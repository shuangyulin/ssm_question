...
<div id="guestBook_manage_tool" style="padding:5px;">
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="guestBookQueryForm" method="post">
			...
			留言人：<input class="textbox" type="text" id="userObj_userInfoname_query" name="userObj.userInfoname" style="width: auto"/>
...
<div id="guestBookEditDiv">
	<form id="guestBookEditForm" enctype="multipart/form-data"  method="post">
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox"  id="guestBook_userObj_userInfoname_edit" name="guestBook.userObj.userInfoname" style="width: auto"/>
			</span>
		</div>
		<div>
