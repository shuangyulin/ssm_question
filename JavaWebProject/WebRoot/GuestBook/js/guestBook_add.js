$(function () {
	...
	$("#guestBook_userObj_userInfoname").combobox({
        ...
        onLoadSuccess: function () { //数据加载完毕事件
            var data = $("#guestBook_userObj_userInfoname").combobox("getData"); 
            if (data.length > 0) {
                $("#guestBook_userObj_userInfoname").combobox("select", data[0].userInfoname);
            }
        }
	});
	//单击添加按钮
