		...
		<div class="row">
			<div class="col-md-10">
				  ...
				  <div class="form-group">
					 <label for="userInfo_userInfoname" class="col-md-2 text-right">用户名:</label>
					 <div class="col-md-8"> 
					 	<input type="text" id="userInfo_userInfoname" name="userInfo.userInfoname" class="form-control" placeholder="请输入用户名">
					 </div>
				  </div> 
				  <div class="form-group">
				  ...
				  <div class="form-group">
				  	 <label for="userInfo_email" class="col-md-2 text-right">邮箱地址:</label>
				  	 <div class="col-md-8">
					    <input type="text" id="userInfo_email" name="userInfo.email" class="form-control" placeholder="请输入邮箱地址">
					 </div>
				  </div>
				  <div class="form-group">
				  	 <label for="userInfo_address" class="col-md-2 text-right">用户住址:</label>
				  	 <div class="col-md-8">
					    <input type="text" id="userInfo_address" name="userInfo.address" class="form-control" placeholder="请输入用户住址">
					 </div>
				  </div>
				  <div class="form-group">
				  	 <label for="userInfo_userPhoto" class="col-md-2 text-right">个人照片:</label>
				  	 <div class="col-md-8">
