...
<div class="container">
	...
	<div class="row bottom15"> 
		...
		<div class="col-md-10 col-xs-6"><%=userInfo.getUserInfoname()%></div>
	</div>
	<div class="row bottom15"> 
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">邮箱地址:</div>
		<div class="col-md-10 col-xs-6"><%=userInfo.getEmail()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">用户住址:</div>
		<div class="col-md-10 col-xs-6"><%=userInfo.getAddress()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">个人照片:</div>
