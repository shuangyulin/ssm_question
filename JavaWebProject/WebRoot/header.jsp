    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>SurveyInfo/frontlist">问卷信息</a></li>
                <li><a href="<%=basePath %>QuestionInfo/frontlist">问题信息</a></li>
                <li><a href="<%=basePath %>SelectOption/frontlist">选项信息</a></li>
                <li><a href="<%=basePath %>Answer/frontlist">答卷信息</a></li>
